...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { entry: @state.entry, name: @state.name, picture_id: @state.picture_id } }, as: :json
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { entry: @state.entry, name: @state.name, picture_id: @state.picture_id } }, as: :json
    assert_response 200
  end
